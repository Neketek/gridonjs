...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridOnJs = function () {
	  ...
	  _createClass(GridOnJs, null, [{
	    ...
	    value: function recalulatePixels(gridIds) {
	      if (gridIds !== undefined) {
	        ...
	        try {
	          for (var _iterator = gridIds[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            var id = _step.value;
	      ...
	      var gridsMap = Grid.gridsMap;
	      var _iteratorNormalCompletion2 = true;
	      var _didIteratorError2 = false;
	      var _iteratorError2 = undefined;

	      try {
	        for (var _iterator2 = gridsMap[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          var kv = _step2.value;
	...
	var GridElement = function () {
	  _createClass(GridElement, null, [{
	    ...
	    value: function checkGridLayoutObject(gridLayoutObject) {
	      ...
	      var props = ["rows", "cols", "gpLeft", "gpTop", "gpRight", "gpBottom"];
	      var _iteratorNormalCompletion = true;
	      var _didIteratorError = false;
	      var _iteratorError = undefined;
...
/***/ function(module, exports) {
	...
	var PixelStyleController = function () {
	  _createClass(PixelStyleController, [{
	    ...
	    key: "convertWHFromPixels",
	    value: function convertWHFromPixels(value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Grid = function () {
	  ...
	  function Grid(domElement) {
	    ...
	    var pLeft = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];
	    var pTop = arguments.length <= 4 || arguments[4] === undefined ? 0 : arguments[4];
	    var pRight = arguments.length <= 5 || arguments[5] === undefined ? 0 : arguments[5];
	    var pBottom = arguments.length <= 6 || arguments[6] === undefined ? 0 : arguments[6];
	    var gpLeft = arguments.length <= 7 || arguments[7] === undefined ? 0 : arguments[7];
	    var gpTop = arguments.length <= 8 || arguments[8] === undefined ? 0 : arguments[8];
	    var gpRight = arguments.length <= 9 || arguments[9] === undefined ? 0 : arguments[9];
	    var gpBottom = arguments.length <= 10 || arguments[10] === undefined ? 0 : arguments[10];
	  ...
	  _createClass(Grid, [{
	    ...
	    value: function transformOneByParamList(params) {
	      ...
	      //paddings
	      var pLeft = params[5] !== undefined ? params[5] : this.pLeft;
	      var pTop = params[6] !== undefined ? params[6] : this.pTop;
	      var pRight = params[7] !== undefined ? params[7] : params[5] ? params[5] : this.pRight;
	      var pBottom = params[8] != undefined ? params[8] : params[6] ? params[6] : this.pBottom;

	      if (elem !== undefined) {
	        elem.transform(this.gpLeft + params[1] + pLeft, this.gpTop + params[2] + pTop, params[3] - (pRight + pLeft), params[4] - (pBottom + pTop));
	      }
	    }
	  }, {
