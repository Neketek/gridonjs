...
/***/ function(module, exports, __webpack_require__) {
	...
	var Layout = __webpack_require__(5).Layout;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TRANSFORMS_LIST = Symbol("TRANSFORMS_LIST");
	...
	var Grid = function () {
	  ...
	  _createClass(Grid, [{
	    ...
	    key: "applyTransfromsByConditions",
	    value: function applyTransfromsByConditions() {
	      var transforms = this.transormsList;
	      var _iteratorNormalCompletion4 = true;
	      var _didIteratorError4 = false;
	      var _iteratorError4 = undefined;

	      try {
	        for (var _iterator4 = transforms[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	          var transform = _step4.value;
	    ...
	    value: function recalulatePixels() {
	      ...
	      try {
	        for (var _iterator5 = elementsMap[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	          var kv = _step5.value;
	...
	var Layout = function () {
	  ...
	  _createClass(Layout, [{
	    ...
	    value: function update() {
	      ...
	      var rows = this.rows;
	      var cols = this.cols;
	      var activeCols = cols - this.ml;
	      var activeRows = rows - this.mt;
	      var elementsInCols = Math.floor(activeCols / this.w);
	      var elementsInRows = Math.floor(activeRows / this.h);
	      var layout = [];
	      var ids = null;
	      var done = false;
	      if (!this.ids) {
	      ...
	      var createSingleTransform = function createSingleTransform(l, t) {
	        var left = _this.pl + _this.ml + (_this.w + _this.ml) * l;
	        var top = _this.pt + _this.mt + (_this.h + _this.mt) * t;
	        var id = ids.next().value;
	        if (id === undefined) {
	          return true;
	        }
	        layout.push([id, left, top, _this.w, _this.h]);
	        return false;
	      };

	      if (this.hor) {
	        for (var l = 0; !done; l++) {
	          for (var t = 0; t < elementsInRows; t++) {
	            done = createSingleTransform(l, t);
	          }
	        }
	      } else {
	        for (var _t = 0; !done; _t++) {
	          for (var _l = 0; _l < elementsInCols; _l++) {
	            done = createSingleTransform(_l, _t);
	          }
	        }
	      }
